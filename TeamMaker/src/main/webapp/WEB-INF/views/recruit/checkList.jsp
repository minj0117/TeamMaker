...
function checkbox(){
	console.log("들어옴");
	var checkedValue=[];
	$("input[name='onoff']:checked").each(function(index, item) {
	      checkedValue.push($(item).val());
	});
	$("input[name='a1']:checked").each(function(index, item) {
	      checkedValue.push($(item).val());
	});
	$("input[name='bun']:checked").each(function(index, item) {
	      checkedValue.push($(item).val());
	});
	
	document.forms[0].action = "${contextPath}/prj/checklist";
...
<body>
	...
	<main>
		<div class="container">
			...
			<div class="content">
				<!-- 사용자 선택 -->
				<form class="content content_up" action="#" method="get">
					<!-- 유형 -->
					<ul class="type">
					...
					<ul class="area">
						...
						<ul class="area content">
							<li><input type="radio" name="a1" id="a1" value="서울" />
								<label for="a1">서울</label></li>
							<li><input type="radio" name="a1" id="a2" value="경기" />
								<label for="a2">경기</label></li>
							<li><input type="radio" name="a1" id="a3" value="인천" />
								<label for="a3">인천</label></li>
							<li><input type="radio" name="a1" id="a4" value="대전" />
								<label for="a4">대전</label></li>
							<li><input type="radio" name="a1" id="a5" value="대구" />
								<label for="a5">대구</label></li>
							<li><input type="radio" name="a1" id="a6" value="부산" />
								<label for="a6">부산</label></li>
							<li><input type="radio" name="a1" id="a7" value="울산" />
								<label for="a7">울산</label></li>
							<li><input type="radio" name="a1" id="a8" value="광주" />
								<label for="a8">광주</label></li>
							<li><input type="radio" name="a1" id="a9" value="강원" />
								<label for="a9">강원</label></li>
							<li><input type="radio" name="a1" id="a10" value="세종" />
								<label for="a10">세종</label></li>
							<li><input type="radio" name="a1" id="a11" value="충북" />
								<label for="a11">충북</label></li>
							<li><input type="radio" name="a1" id="a12" value="충남" />
								<label for="a12">충남</label></li>
							<li><input type="radio" name="a1" id="a13" value="경북" />
								<label for="a13">경북</label></li>
							<li><input type="radio" name="a1" id="a14" value="경남" />
								<label for="a14">경남</label></li>
							<li><input type="radio" name="a1" id="a15" value="전북" />
								<label for="a15">전북</label></li>
							<li><input type="radio" name="a1" id="a16" value="전남" />
								<label for="a16">전남</label></li>
							<li><input type="radio" name="a1" id="a17" value="제주" />
								<label for="a17">제주</label></li>
							<li><input type="radio" name="a1" id="a18" value="전국" />
					...
					<ul class="field">
						...
						<ul class="field content">
							<li><input type="radio" name="bun" id="gong" value="공모전" />
								<label for="gong">공모전</label></li>
							<li><input type="radio" name="bun" id="dae" value="대외활동" />
								<label for="dae">대외활동</label></li>
							<li><input type="radio" name="bun" id="study"
            ...
            <div class="btnGrp">
              ...
              <div>
				...
				<div class="paging">
					...
					<form id="pagingFrm" name="pagingForm" action="checklist"
						method="get">
