...
<html lang="en">
  <head>
    ...
    <script
      ...
      crossorigin="anonymous"
    ></script>
	    <link rel="stylesheet" href="${contextPath }/prj/css/member/modifyForm.css" />
    <!-- font awesome -->
    <script
              ...
              <fieldset>
                <ul>
                  <li>
                    ...
                    <div id="id">${sessionScope.member.id }</div>
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    <input type="date" id="birth" name="birth" value="${sessionScope.member.birth }" readonly="readonly"/>
                  </li>
                  <li>
                    <label for="gender">성별</label>
                    <div>
                      <input type="radio" name="gender" value="남" ${sessionScope.member.gender == "남" ? 'checked="checked"' : ''} 
			 ...
			 <input type="radio" name="gender" value="여" ${sessionScope.member.gender == "여" ? 'checked="checked"' : ''}
			 	onclick="return(false);"/>여<br>
                  ...
                  <li>
                    ...
                    <input type="text" id="phone" name="phone" value="${sessionScope.member.phone }"/>
                  </li>
                  <li>
                    <label for="email">이메일</label>
                    <input type="text" id="email" name="email" value="${sessionScope.member.email }"/>
                    <input type="button" value="코드 전송" />
                  </li>
                  <li>
                    <label for="free">자기소개서</label>
                    <textarea name="free" id="free">${sessionScope.member.free }</textarea>
                    <div></div>
                  </li>
                </ul>
                <div class="btnGrp">
