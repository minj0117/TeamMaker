...
<body>
	...
	<main>
		<c:if test="${toggle eq 1 }">
			<div class="container">
				<div class="writeTitle">[공모전 작성]</div>
				<form action="${contextPath }/prj/gong/insertGong"
		...
		<c:if test="${toggle eq 2 }">
			<div class="container">
				<div class="writeTitle">[공모전 수정]</div>
				<form action="${contextPath }/prj/gong/gongMod"
					enctype="multipart/form-data" method="post">
					<table>
						<thead>
							<tr>
						...
						<tbody id="addtbody">
							<tr>
								<td>작성자</td>
								<td><input type="text" id="writer" name="writer"
									value="${gongVO.writer }" readonly="readonly" /></td>
							</tr>
							<tr>
								<td>제목</td>
								<td><input type="text" id="title" name="title"
									value="${gongVO.title }" /></td>
							</tr>
							<tr>
								<td>카테고리</td>
								<td><select id="category" name="category">
							...
							<tr>
								<td>모집일</td>
								<td><input type="date" id="applystart" name="applystart"
									value="${gongVO.applystart }" /> ~ <input type="date"
									id="applyend" name="applyend" value="${gongVO.applyend }"></td>
							</tr>
							<tr>
								<td>시작일</td>
								<td><input type="date" id="startday" name="startday"
									value="${gongVO.startday }" /></td>
							</tr>
							<tr>
								<td>주최</td>
								<td><input type="text" id="host" name="host"
									value="${gongVO.host }" /></td>
							</tr>
							<tr>
								<td>내용</td>
								<td><input type="text" id="g_comment" name="g_comment"
									value="${gongVO.g_comment }" /></td>
							</tr>
							<tr>
								<td>등록방법</td>
