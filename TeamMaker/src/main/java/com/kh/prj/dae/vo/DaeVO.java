...
public class DaeVO {
	...
	private Date applystart;	//APPLYSTART	DATE	No		6	신청시작날
	private Date applyend;		//APPLYEND	DATE	No		7	신청마감날
	private Date startday;		//STARTDAY	DATE	No		8	대외활동 시작날
	private String host;		//HOST	VARCHAR2(100 BYTE)	No		9	주최자
	private String way;			//WAY	VARCHAR2(100 BYTE)	No		10	등록방법
